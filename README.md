...
Разработанная база данных содержит меню с разделами: "Автомобили", "Заказы на обслуживание", "База данных".

В разделе "Автомобили" пользователь может:
1. Создать новый автомобиль в базе данных. Необходимо ввести такую информацию об автомобиле: "Марка автомобиля", "Модель автомобиля", "Год выпуска", "Номер заказа".
2. Вывести информацию об автомобиле на экран.

В разделе "Заказы на обслуживание" пользователь может:
1. Создать новый заказ на обслуживание автомобиля. Необходимо ввести такую информацию о заказе: "Автомобиль", "Дата и время заказа", "Описание работ".
2. Вывести информацию о заказе на экран.

В разделе "База данных" пользователь может:
1. Добавить новый заказ в файл.
2. Вывести все заказы из файла.
3. Поиск автомобиля по номеру автомобиля.
4. Удаление заказа из файла.

В разработке:
1. Склад. (Возможность вести складской учет наличия автозапчастей, их количество и стоимость. А также легко и быстро провести анализ ассортимента или провести инвентаризацию. Добавлять и удалять товары, а также вывод на экран перечень товаров на складе.)
